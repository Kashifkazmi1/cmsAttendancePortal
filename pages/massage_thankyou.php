  ...
  <main class="main-content  mt-0">
    <div class="page-header align-items-start min-vh-100" style="background-image: url('../assets/img/profile3.jpg');">
      ...
      <main class="px-3">
        ...
        <p class="lead text-light text-center"><i class="fa fa-heart" aria-hidden="true"> </i> <?=$_SESSION['username']?> your Application submited successfully  at <?php 
         date_default_timezone_set('Asia/Karachi'); $today = date("F j, Y, g:iA"); echo $today;  ?>  </p>
        <p class="lead text-light text-center">
          <a href="/cms/pages/profile.php" class="btn color text-center text-light bg-info">Profile</a>
        </p>
      </main>
