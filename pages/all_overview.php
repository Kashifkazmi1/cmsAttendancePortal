                ...
                <div class="card-header pb-0 p-3">
                  <div class="row">
                    <div class="col-md-8 d-flex align-items-center">
                      <h6 class="mb-0 text-info">Attendance overview </h6>
                      </div>
                      <div class="container">
            ...
            <div class="card-header pb-0">
              <div class="row">
                <div class="col-lg-6 col-7">
                  <p> User's Attendance  </p>
                  <p class="text-sm mb-0">
                    <i class="fa fa-check text-info" aria-hidden="true"></i>
                    <span class="font-weight-bold ms-1 text-info"> <?=$_SESSION['username']?>!</span>Today All Entries record listed blow .
                  </p>
                </div>
              ...
              <div class="table-responsive">
                <table class="table align-items-center mb-0">
                  ...
                  <!-- body  -->
                    ...
                    $sql="select users.username,users.pp,attendance.name ,attendance.status,attendance.date,attendance.time,attendance.late from attendance,users where attendance.date='$todaydate' AND users.username=attendance.name AND attendance.status = 'Present' OR attendance.status = 'Application' OR attendance.status = 'absent'
                    ";
