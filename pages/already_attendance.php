  ...
  <main class="main-content  mt-0">
    <div class="page-header align-items-start min-vh-100" style="background-image: url('../assets/img/profile3.jpg');">
      ...
      <main class="px-3">
        ...
        <h1 class="text-light text-center" > Dear <span class="info"><?=$_SESSION['username']?> </span>! </h1>
        <p class="lead text-light text-center">   Your Attendance Already Saved . Don't worry go back on dashboard.  </p>
