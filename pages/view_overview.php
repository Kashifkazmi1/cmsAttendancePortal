              ...
              <div class="table-responsive">
                <table class="table align-items-center mb-0">
                  ...
                  <!-- body  -->
                    ...
                    $sql="select users.username,users.pp,attendance.name ,attendance.status,attendance.status,attendance.date,attendance.time,attendance.late from attendance,users where attendance.date='$todaydate' AND users.username = attendance.name;";
