                ...
                <div class="card-header pb-0 p-3">
                  <div class="row">
                    <div class="col-md-8 d-flex align-items-center">
                      <h6 class="mb-0 text-info">Daily-Applications </h6>
                      </div>
                      <div class="container">
            ...
            <div class="card-header pb-0">
              <div class="row">
                <div class="col-lg-6 col-7">
                  <p> User's Applications  </p>
                  <p class="text-sm mb-0">
                    <i class="fa fa-check text-info" aria-hidden="true"></i>
                    <span class="font-weight-bold ms-1 text-info"> <?=$_SESSION['username']?>!</span>Today Applications  record listed blow .
                  </p>
                </div>
              ...
              <div class="table-responsive">
                <table class="table align-items-center mb-0">
                  ...
                  <!-- body  -->
                    ...
                    $sql="select users.username,users.pp,attendance.name ,attendance.status,attendance.date,attendance.time,attendance.late from attendance,users where attendance.date='$todaydate' AND users.username = attendance.name AND attendance.status = 'Leave';
                    ";
                       ...
                       <tr>
                         ...
                         <td class="align-middle text-center text-sm">
                               ...
                               <div class="progress-percentage">
                                 <span class="text-xs font-weight-bold text-warning">('.$row [ 'status' ].')</span>
                               </div>
